...
RESCOMP = windres
DEFINES += -DFMT_UNICODE=0 -DMSDFGEN_USE_CPP11
INCLUDES += -Iinclude -Icore -Ifreetype/include
FORCE_INCLUDE +=
...
GENERATED += $(OBJDIR)/DistanceMapping.o
...
GENERATED += $(OBJDIR)/convergent-curve-ordering.o
...
GENERATED += $(OBJDIR)/save-fl32.o
GENERATED += $(OBJDIR)/save-png.o
GENERATED += $(OBJDIR)/save-rgba.o
...
OBJECTS += $(OBJDIR)/DistanceMapping.o
...
OBJECTS += $(OBJDIR)/convergent-curve-ordering.o
...
OBJECTS += $(OBJDIR)/save-fl32.o
OBJECTS += $(OBJDIR)/save-png.o
OBJECTS += $(OBJDIR)/save-rgba.o
...
$(OBJDIR)/DistanceMapping.o: core/DistanceMapping.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/contour-combiners.o: core/contour-combiners.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/convergent-curve-ordering.o: core/convergent-curve-ordering.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/equation-solver.o: core/equation-solver.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/export-svg.o: core/export-svg.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/save-bmp.o: core/save-bmp.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/save-fl32.o: core/save-fl32.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/save-rgba.o: core/save-rgba.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
